...
CREATE TABLE `history_tm_submissions` (
  ...
  `sMetadata` mediumtext DEFAULT NULL,
  ...
  `bOffline` tinyint NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
